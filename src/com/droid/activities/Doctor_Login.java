 ...
 * 
 * Class:Doctor_Login
 * Description:This is the activity for login screen.Checks the username and password and navigates to other pages accordingly
 * 
 * 
 * **/
...
public class Doctor_Login extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		Button launch = (Button) findViewById(R.id.doctor_login_button);
		...
		launch.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View viewParam) {
				...
				EditText usernameEditText = (EditText) findViewById(R.id.doctor_username);
				EditText passwordEditText = (EditText) findViewById(R.id.doctor_password);
				...
				if (InputFieldValidations.IsEmpty(sUserName)|| InputFieldValidations.IsEmpty(sPassword)) {
					...
					/**validating if doctor is entering into application**/
					if (sUserName.substring(0, 3).equals("DOC")) {

						String result = login(sUserName, sPassword);
						if (result == "success") {
							Log.i("Connection", "Sending message doctor");
							try {
								...
								ConstantsFile.doctorClass = (Class<Doctor>)ConstantsFile.foreignContext.getClassLoader().loadClass("com.droid.activities.Doctor");
								Intent intent = new Intent(Doctor_Login.this, ConstantsFile.doctorClass);
		...
		forgot.setOnClickListener(new OnClickListener() {
            ...
            //
				...
				try {
					...
					ConstantsFile.foreignContext = createPackageContext(ConstantsFile.packageName,Context.CONTEXT_IGNORE_SECURITY| Context.CONTEXT_INCLUDE_CODE);
					ConstantsFile.passwordDoctorClass = (Class<Password_Doctor>) ConstantsFile.foreignContext.getClassLoader().loadClass(ConstantsFile.password_doctor);
					Intent intent = new Intent(Doctor_Login.this, ConstantsFile.passwordDoctorClass);
