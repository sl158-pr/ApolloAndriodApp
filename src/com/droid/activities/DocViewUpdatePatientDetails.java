...
public class DocViewUpdatePatientDetails extends Activity {
	...
	public void onCreate(Bundle icicle) {
		...
		System.out.println("Inside Oncreate:: DocViewUpdatePAtientDetails");
...
/*					ConstantsFile.foreignContext = createPackageContext(
				...
				Intent intent = new Intent(v.getContext(), ConstantsFile.doctorClass);
		...
		btnUpdate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!(ifValid.equals("valid"))) {
					...
					Toast.makeText(DocViewUpdatePatientDetails.this,
							ifValid,
					...
					if (result == "success") {
						...
						finish();
						 ...
						 Toast.makeText(DocViewUpdatePatientDetails.this,"Problem creating patient record.. Please check that all fields are filled in.",
						 Toast.LENGTH_SHORT).show();
						Log.i("PatientRecordUpdate",
