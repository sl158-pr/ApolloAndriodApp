...
public class Password extends Activity{
     ...
     //   oldPwdEditText.setEnabled(false);
                  ...
                  if(sNewPwd.equals(sConfirmPwd)){
            	   ...
            	   if(result=="success"){
            		 ...
            		 System.out.println("Password update successful..."); 
						...
						lblResult
						.setText("Password update failed.");
					}
        ...
        btnCancel.setOnClickListener(new OnClickListener() {
     		...
     		try {
     			...
     			ConstantsFile.patientLoginClass = (Class<Patient_Login>) ConstantsFile.foreignContext.getClassLoader().loadClass(ConstantsFile.patient_login);
     			Intent intent = new Intent(Password.this, ConstantsFile.patientLoginClass);
 ...
 // Query Verify function to send Query1 and Query2 for backend verification
 	public static String Queryverify(String sQueryText1, String sQueryText2) {
 		...
 		try {
 			...
 			Log.i("Connection", "Encoding message: Query1 was: " + sQueryText1
 					+ " and Query2 was: " + sQueryText2);
