...
public class AdminCreatePatientDetails extends Activity {
		...
		btnBack.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				try {
					...
					Intent intent = new Intent(AdminCreatePatientDetails.this,
		...
		btnCreate.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!(ifValid.equals("valid"))) {
					Toast.makeText(AdminCreatePatientDetails.this,
							ifValid,
					...
					String result = createPatientRecord(sPatientName, sAge,

					sPrimaryDoc, sSecondaryDoc, sEmail, sGender, sBloodType,
							sBP, sAllergies, sDiagnosis);
